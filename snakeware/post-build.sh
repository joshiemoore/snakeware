...
# install pip modules
$SNAKEWARE/buildroot/output/target/usr/bin/python3 -m pip install --global-option=build_ext --global-option="-I/usr/include/python3.8" --global-option="-I/usr/include/" -r $SNAKEWARE/config/pip_modules.txt
